...
#define MACHO_SETTINGS_LOAD_DATA_VARIABLES DWARF_SETTINGS_GROUP ".loadDataVariables"
#define MACHO_SETTINGS_LOAD_FUNCTIONS DWARF_SETTINGS_GROUP ".loadFunctions"
